      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            I help busy founders and solo builders launch their <strong>MVPs, AI tools, or landing pages</strong> — fast, clean, and conversion-optimized. No team required. Just smart tools and proven systems.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 hover:bg-white/30 transition-all duration-300 group">
              ...
              <p className="text-slate-600 text-sm">Get your MVP live in weeks, not months</p>
            </div>
            ...
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 hover:bg-white/30 transition-all duration-300 group">
              ...
              <p className="text-slate-600 text-sm">Smart tools and automation built-in</p>
            </div>
            ...
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 hover:bg-white/30 transition-all duration-300 group">
              ...
              <p className="text-slate-600 text-sm">Designed to turn visitors into customers</p>
            </div>
          </div>
        </div>
      </div>
