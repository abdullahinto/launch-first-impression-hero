      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-md bg-white/30 border border-white/40 text-sm font-medium text-slate-700 mb-8 hover:bg-white/40 transition-all duration-300 group">
            ...
            AI-first developer for startup founders
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
          </div>

          {/* Main Headline - H1 for SEO */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="block text-slate-900 mb-2">Launch your MVP fast</span>
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            I help busy founders ship <strong>MVPs, AI tools, and conversion-focused landing pages</strong> in weeks, not months. 
            <br />
            No team drama. No endless revisions. Just smart builds that work.
          </p>

          {/* Name & Title */}
          <div className="mb-12">
            <h2 className="text-2xl font-semibold text-slate-800 mb-2">Muhammad Abdullah</h2>
            <p className="text-lg text-slate-600 flex items-center justify-center gap-2">
              <Zap className="w-5 h-5 text-yellow-500" />
              End-to-end MVP launch specialist • Solo founder-friendly
            </p>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2">
              <Calendar className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" />
              Let's Ship Your Idea
            ...
            <button className="group px-8 py-4 backdrop-blur-md bg-white/30 border border-white/40 text-slate-700 font-semibold rounded-xl hover:bg-white/50 transition-all duration-300 hover:scale-105 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 hover:bg-white/30 transition-all duration-300 group">
              ...
              <h3 className="font-semibold text-slate-800 mb-2">Ship in Days</h3>
              <p className="text-slate-600 text-sm">Most founders wait months. You'll launch this week.</p>
            </div>
            ...
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 hover:bg-white/30 transition-all duration-300 group">
              ...
              <h3 className="font-semibold text-slate-800 mb-2">AI-Powered Builds</h3>
              <p className="text-slate-600 text-sm">Smart automation meets clean code</p>
            </div>
            ...
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-xl p-6 hover:bg-white/30 transition-all duration-300 group">
              ...
              <h3 className="font-semibold text-slate-800 mb-2">Conversion-First</h3>
              <p className="text-slate-600 text-sm">Built to turn visitors into paying customers</p>
            </div>
          </div>
        </div>
      </div>
